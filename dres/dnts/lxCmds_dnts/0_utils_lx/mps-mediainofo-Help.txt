...
Chapters_Format_WithHint_List Chapters Codecs in this file with popular name (hint), separated by /
...
Format_Settings_FrameStructures Settings needed for decoder used, detailled (Type of frame, and field/frame info)
InternetMediaType Internet Media Type (aka MIME Type, Content-Type)
...
Height Original (in the raw stream) Height in pixel
Height/String Original (in the raw stream) Height with measurement (pixel)
Height_Original Height in pixel
Height_Original/String Height with measurement (pixel)
...
Delay-Original/String4 Delay in format : HH:MM:SS:FF (HH:MM:SS
...
Chapters_Pos_End Used by third-party developpers to know about the end of the chapters list (this position excluded)
