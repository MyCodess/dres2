##________________ MS-Apps-uninstalls : ______________________________________________

##-- https://theitbros.com/sysprep-windows-machine/ /_220918 :
##-- Here is a list of the pre-installed Microsoft apps in Windows 10 21H1.
##-- Uninstall Built-in Microsoft Store Apps
